      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-stretch gap-8 px-6 py-10 md:grid-cols-[0.92fr_1.08fr] md:gap-12 md:py-14 lg:min-h-[680px]">
        ...
        <div className="order-1 relative min-h-[430px] md:order-2 md:min-h-full">
          ...
          {hero.startingFromValue ? (
            <div className="absolute bottom-4 left-4 z-10 max-w-[220px] rounded-xl border border-[var(--color-home-border)] bg-white/95 p-5 shadow-[0_18px_48px_rgba(24,21,18,0.12)] backdrop-blur-sm md:bottom-8 md:left-8">
          ...
          <div className="absolute right-4 top-4 hidden max-w-[230px] rounded-xl border border-white/70 bg-white/82 p-4 text-sm text-neutral-700 shadow-[0_16px_46px_rgba(24,21,18,0.10)] backdrop-blur md:block">
